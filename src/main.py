...
np.savetxt("iter_loss"+str(opt.name)+".csv", model.iter_losses, delimiter=",")
plt.savefig("1_"+str(opt.name)+".png")
plt.close(fig1)

fig2 = plt.figure()
plt.semilogy(range(len(model.epoch_losses)), model.epoch_losses)
np.savetxt("epoch_loss"+str(opt.name)+".csv",  model.epoch_losses, delimiter=",")
